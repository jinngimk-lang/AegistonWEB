          ...
          {data.products.map((product, index) => (
            <div className="solution" key={product.slug} id={product.slug}>
              <Reveal className="solution-body">
                ...
                <h2>{productDisplayName(product.slug, product.nameEn)}</h2>
              ...
              <Reveal className="solution-visual" delay={1}>
                ...
                <span className="vlabel">
                  {productDisplayName(product.slug, product.nameEn).toUpperCase()} / {product.tierLabel}
                </span>
              </Reveal>
            </div>
          ))}
          ...
          <div className="container">
            ...
            <CapabilityMatrix
              ...
              productNames={data.products.map((product) => ({
                slug: product.slug,
                name: productDisplayName(product.slug, product.nameEn),
